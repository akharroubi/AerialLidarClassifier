...
- Compatibility declaration limited to QGIS 3.x; QGIS 4 requires validation.
...
- Cooperatively cancel installers and retain download threads independently of their dialogs.
