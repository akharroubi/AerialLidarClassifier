...
from . import _shims as flash_attn  # pure-torch attention (plugin)
import spconv.pytorch as spconv
import torch
import torch.nn as nn
from . import _shims as torch_scatter  # pure-torch segment_csr (plugin)

from ._attrdict import Dict  # minimal attribute dict (plugin)
from timm.layers import DropPath

from .pointrope_torch import PointROPE  # pure-torch RoPE (plugin)
